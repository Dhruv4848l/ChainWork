...
/* WK-13 composer — hire-scoped. Persists via the server action, then refreshes the thread. */
export function MessageComposer({ hireId }: { hireId: string }) {
  ...
  return (
    <div className="border-t border-line px-6 py-3.5">
      ...
      <p className="mt-2 text-[10.5px] text-ink3">
        Messages here may be used as evidence if this job is disputed.
      </p>
    </div>
  );
}
