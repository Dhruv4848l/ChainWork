...
const TYPE_COLOR: Record<string, string> = {
  PAYMENT: "bg-emerald", ESCROW: "bg-[#8FC7E8]", DISPUTE: "bg-ember",
  REMINDER: "bg-amber", APPLICATION: "bg-bronze",
};
  ...
  return (
    <div className="max-w-2xl">
      ...
      <Card className="overflow-hidden p-0">
        {notifs.map((n) => (
          <div key={n.id} className={`flex items-start gap-3.5 border-b border-hair px-6 py-4 last:border-b-0 ${n.read ? "" : "bg-bronze/[0.04]"}`}>
